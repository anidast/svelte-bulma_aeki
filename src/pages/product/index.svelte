<script>
    ...
    // let product = {
    //     product_name: "kursi",
    //     product_description: "sebuah kursi",
    //     product_price: 120500,
    //     product_vendor: "Mebel International",
    //     product_category: "chair",
    //     product_durability: "Tahan 10Kg",
    //     product_width: 60,
    //     product_color: "Merah",
    ...
    const getproduct = (async () => {
        ...
        // const response2 = await fetch(apiUrl + "product/category/" + product.product_category, {
        //     method: "GET",
        // });
